	...
	<div class="col-lg-12 col-xs-12">
		<div class="box-content">
			...
			<ul class="nav nav-tabs" id="myTabs" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<a href="<?php echo site_url('reportdosen/mahasiswa')?>" ><button class="nav-link active" id="cpl-tab" data-bs-toggle="tab" data-bs-target="#cpl" type="button" role="tab" aria-controls="cpl" aria-selected="true">Rapor Mahasiswa</button></a>
				</li>
				<li class="nav-item" role="presentation">
						...
						<div class="col-xs-12">
							<div class="invoice-box" style="font-style: 'calibri'; ">
								...
								<div class="float-end margin-top-50">
									...
									<form role="form" id="contactform" action="<?php echo site_url('reportdosen/download_report_mahasiswa')?>" method="post" target="_blank">
