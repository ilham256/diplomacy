	...
	<div class="col-lg-12 col-xs-12">
		<div class="box-content">
			...
			<ul class="nav nav-tabs" id="myTabs" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<a href="<?php echo site_url('reportdosen/relevansi_ppm')?>" ><button class="nav-link active" id="cpl-tab" data-bs-toggle="tab" data-bs-target="#cpl" type="button" role="tab" aria-controls="cpl" aria-selected="true">Relevansi PPM</button></a>
				</li>
				<li class="nav-item" role="presentation">
