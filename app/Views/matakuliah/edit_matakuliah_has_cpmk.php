              ...
              <form role="form" method="post" action="<?php echo site_url('matakuliah/submit_edit_matakuliah_has_cpmk') ?>" enctype="multipart/form-data">
	                <div class="card-body">
			                  ...
			                  <div class="form-group">
			                    ...
			                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Deskriptor" name="deskripsi" value="<?= $data[0]->deskripsi_matakuliah_has_cpmk ?>"  maxlength="100" minlength="2" required >
			                  </div>
			                  <br>
